...
class Functional():
    """
        ...
        # TODO: decide whether to pass μ, Σ as-is (one per class), or by point
...
def binary_cluster_margin(X, Y, μ=None, weight=1.0):
    ...
    # TODO: pass actual means to allow for backprop into those
    μ_0 = X[Y==0].mean(0)
    μ_1 = X[Y==1].mean(0)
    ...
    # FIXME: This is super inefficient. diffs_μ[i,j,:] can only have three values: 0, μ_0-μ_1 or μ_1-μ_0,
